...
public class LegalMemberList extends AppCompatActivity {
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legal_member_list);
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(LegalMemberList.this,DashboardActivity.class);
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(LegalMemberList.this)) {
                    ...
                    Toast.makeText(LegalMemberList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void GetCommunityListAPI() {
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api_Urls.BaseURL+"GetLegalMemberList", new Response.Listener<String>() {
            @Override
...
//                 Toast.makeText(getApplicationContext(),""+response,Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        pdfAdapTer = new LegalListAdapter(LegalMemberList.this, arrLegalList);
                        cust_recyclerView.setLayoutManager(layoutManager);
                        cust_recyclerView.setAdapter(pdfAdapTer);
                    } else {
                        Toast.makeText(LegalMemberList.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(LegalMemberList.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(LegalMemberList.this);
    ...
    public class LegalListAdapter extends RecyclerView.Adapter<LegalList> {
        ...
        public LegalList onCreateViewHolder(ViewGroup parent, int viewType) {
            return new LegalList(LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_alllegelmember, parent, false));
        }
